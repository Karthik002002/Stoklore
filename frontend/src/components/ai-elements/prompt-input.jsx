...
export const PromptInputTabsList = ({ className, ...props }) => <div className={cn(className)} {...props} />

export const PromptInputTab = ({ className, ...props }) => <div className={cn(className)} {...props} />

...
export function sideCost(account, price, qty) {
...
export function tradeCosts(trade, account) {
  ...
  const add = (key) => entry[key] + (exit?.[key] ?? 0)
  return {
...
export function tradeNetPnl(trade, account) {
...
export function tradeNetReturnPct(trade, account) {
...
export function roundTripCost(account, price, qty) {
...
export function accountHasCosts(account) {
...
export function accountFor(trade, byId) {
